package pt.diogoazevedo.SpringAngularFullStack;
...
public class SpringAngularFullStackApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringAngularFullStackApplication.class, args);
	}
